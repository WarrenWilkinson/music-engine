(defsystem "cl-pipewire"
  ...
  :components ((:file "packages")
	       (:cffi-grovel-file "cl-pipewire-grovelling")
	       (:cffi-wrapper-file "cl-pipewire-wrapper")
	       ;;(:file "example")))
	       (:file "cl-pipewire")))
	       ...
	       ;; ;; 					"spa/param/props\\.h$"
	       ;; ;; 					"spa/param/props-types\\.h$"
	       ;; ;; 					"spa/param/route\\.h$"
	       ;; ;; 					"spa/param/route-types\\.h$"
	       ;; ;; 					"spa/param/tag\\.h$"
	       ;; ;; 					"spa/param/tag-types\\.h$"
	       ;; ;; 					"spa/param/tag-utils\\.h$"
	       ...
	       ;; ;; 					"spa/utils/list\\.h$"
	       ;; ;; 					"spa/utils/names\\.h$"
	       ;; ;; 					"spa/utils/ratelimit\\.h$"
	       ;; ;; 					"spa/utils/result\\.h$"
	       ;; ;; 					"spa/utils/ringbuffer\\.h$"
	       ;; ;; 					"spa/utils/string\\.h$"
	       ;; ;; 					"spa/utils/type\\.h$"
	       ;; ;; 					"spa/utils/type-info\\.h"
	       ;; ;; 					"inttypes\\.h$" ;; 1. for uint32_t and related
	       ;; ;; 					"stdint.*\\.h$" ;; 2.  
	       ;; ;; 					"types\\.h$"    ;; 3.
	       ;; ;; 					)
               ;; ;;                :exclude-sources :all
